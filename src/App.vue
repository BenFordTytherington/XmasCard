...
<template>
  <Renderer ref='renderer' :orbitCtrl="true" resize="window">
    ...
    <Scene :background="0x232226">
      ...
      <GltfModel src="public/Christmas Tree.glb" v-for="i in 60" :scale="getScale(0.2 + (Math.random() * 0.1))" 
      ...
      <Cylinder ref='ground' :radiusTop="50" :radiusBottom="55" :height="8" :radialSegments="64" :heightSegments="32">
        <LambertMaterial >
          <Texture src="public/woodTex.jpg" />
        </LambertMaterial>
      </Cylinder>

      <Box :position="{x: 0, y: 35, z: 0}" :scale="{x: 20, y: 20, z: 20}">
        <LambertMaterial>
          <Texture src="public/CubeTex/tex.jpg"/>
        </LambertMaterial>
      </Box>
